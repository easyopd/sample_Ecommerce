          ...
          <div className="flex flex-wrap md:text-left text-center order-first">
            ...
            <div className="lg:w-1/5 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li><Link to="/" className="text-gray-600 hover:text-gray-800"
                  style={{ color: mode === 'dark' ? 'white' : '' }}>Home</Link></li>
                <li><Link to="/order" className="text-gray-600 hover:text-gray-800"
                  style={{ color: mode === 'dark' ? 'white' : '' }}>Order</Link></li>
                <li><Link to="/cart" className="text-gray-600 hover:text-gray-800"
                  style={{ color: mode === 'dark' ? 'white' : '' }}>Cart</Link></li>
                <li><a href='/images/registration.jpeg' className="text-gray-600 hover:text-gray-800"
            ...
            <div className="lg:w-1/5 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li><Link to="/returnpolicy" className="text-gray-600 hover:text-gray-800"
                  style={{ color: mode === 'dark' ? 'white' : '' }}>Return Policy</Link></li>
                <li><Link to="/about" className="text-gray-600 hover:text-gray-800"
                  style={{ color: mode === 'dark' ? 'white' : '' }}>About</Link></li>
                <li><Link to="/contact" className="text-gray-600 hover:text-gray-800"
            ...
            <div className="lg:w-1/5 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li><Link to="/privacypolicy" className="text-gray-600 hover:text-gray-800"
            ...
            {/* GI Tag Section */}
            <div className="lg:w-1/5 md:w-1/2 w-full px-4">
              <h4 className='rounded-lg:w-1/5 md:w-1/2 w-full px-4 font-bold'>GI Tag</h4>
              <img src="/images/gilogo.jfif" alt="Logo"
          ...
          <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <Link to="/" className='flex'>
              <h1 className='text-2xl font-bold text-black px-2 py-1 rounded'
                style={{ color: mode === 'dark' ? 'white' : '' }}>Hunar-Pashmina</h1>
            </Link>
